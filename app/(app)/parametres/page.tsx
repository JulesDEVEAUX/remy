...
import { createHouseholdNeedAction, deleteHouseholdNeedAction, deletePersonAction } from './actions';
...
export default async function ParametresPage() {
  ...
  const [people, theme, householdNeeds, ingredients] = await Promise.all([
