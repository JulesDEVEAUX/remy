...
export default async function OnboardingPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col gap-8 bg-cream p-8">
      <Wordmark size={32} />
      <div>
        <h1 className="font-display text-[30px] leading-tight text-ink">Configure ton foyer</h1>
        <p className="mt-2 font-sans text-[14px] text-clay-700">
